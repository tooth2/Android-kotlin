...
import edu.cmu.dessertpusher.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.i("[Timber] onCreate Called")
        //dessertsSold = 0
    ...
    override fun onStart() {
        ...
        //dessertTimer.startTimer() // move to Observer
    }
    ...
    override fun onStop() {
       ...
       // dessertTimer.stopTimer() //move to Observer
    }
